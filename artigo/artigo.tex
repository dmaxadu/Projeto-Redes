...
\begin{abstract}
  ...
  coup of February 2021 (cyber attacks and route manipulation,
  in relation to Myanmar civil war). Using public data
...
\begin{resumo}
  ...
  em Myanmar (fevereiro de 2021), enquadrando o problema nos ataques cibernéticos e manipulação de rotas
  em relação à questão da guerra civil em Myanmar. Usando dados públicos do RIPE RIS,
...
Este trabalho investiga os \textbf{ataques cibernéticos e
manipulação de rotas BGP} em relação à \textbf{guerra civil em Myanmar}, 
com foco no período de fevereiro a abril de 2021.
...
\textbf{Ataques cibernéticos e manipulação de rotas},
...
relação à guerra civil em Myanmar utilizando
