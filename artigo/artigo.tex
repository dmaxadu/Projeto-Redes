...
\author{[Nome do Autor 1]\inst{1}, [Nome do Autor 2]\inst{1}}

\address{Departamento de Ciência da Computação\\
  Universidade Federal do Rio de Janeiro (UFRJ) -- Rio de Janeiro -- RJ -- Brasil
  \email{\{autor1, autor2\}@dcc.ufrj.br}
}
...
A Figura~\ref{fig:withdrawals} (a produzir via RIPEstat/BGPStream) deve
mostrar o volume de withdrawals por hora para AS9988, AS136168, AS132748 e
AS132167 ao longo de fevereiro de 2021. Esperamos observar:
...
A Figura~\ref{fig:hijack} (a produzir via RouteViews MRT) deve mostrar a
linha do tempo de anúncios para o prefixo \texttt{104.244.42.0/24} em 5 de
fevereiro de 2021, evidenciando a transição entre AS de origem legítimo
(AS13414) e ilegítimo (AS136168) e a posterior retirada do anúncio.
...
A Figura~\ref{fig:correlacao} (a produzir com dados do IODA e Cloudflare Radar)
deve sobrepor, para o período de fevereiro a abril de 2021: (a) o índice de
visibilidade de prefixos BGP para Myanmar; e (b) o índice de tráfego do
Cloudflare Radar normalizado (0--100). A análise desse gráfico permite
distinguir três padrões diagnósticos:
